var app = angular.module('hdupload',['angular-loading-bar'])


app.controller('heardUlOAD', ['$scope','cfpLoadingBar', function($scope,cfpLoadingBar){

	$scope.creds = {
  bucket: 'heardio/users',
  access_key: null, // REMOVED FOR PRIVACY CONCERNS
  secret_key: null // REMOVED FOR PRIVACY CONCERNS
}
...
$scope.upload = function() {
  ...
  if($scope.file) {
    ...
    bucket.putObject(params, function(err, data) {
      ...
      toastr.success('Successfully uploaded media')
      }
    })
